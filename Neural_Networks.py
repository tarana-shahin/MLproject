...
def L_layer_model(X,Y, layers_dims, learning_rate, num_iterations,split_test_ratio):
    ...
    X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size = split_test_ratio, random_state = 0)

    # conver to the list
    list = layers_dims.split (",")
    # print "list: ", list
...
# convert each element as integers
    ...
    # m = X_train.shape[1]
    parameters = initialize_parameters_deep(layers_d)
    ...
    senst,speci,acc=evaluate(Y_test,Y_prediction_test), 
           

        

    return costs,acc,senst,speci
